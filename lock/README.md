...
```
import (
    "gitlab.sicepat.tech/platform/golib/lock"
    _ "gitlab.sicepat.tech/platform/golib/lock/etcd"
    _ "gitlab.sicepat.tech/platform/golib/lock/redis"
    _ "gitlab.sicepat.tech/platform/golib/lock/zk"
)
